...
write_iso=open("iso_fake_reviews.txt","w")
write_dbscan=open("dbscan_fake_reviews.txt","w")
write_ocsvm=open("ocsvm_fake_reviews.txt","w")
output_string=""
import nltk
